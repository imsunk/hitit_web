		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb">
					...
					<li class="active"><%=board.getCATEGORY() %> 게시판</li>
				</ol>
			</div>
			<!-- col-lg-12 -->
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel-group" id="accordion">
					<form action="<%=request.getContextPath()%>/BoardReplyAction.bo"
						method="post" name="boardform">

						<input type="hidden" name="B_NUM" value="<%=board.getB_NUM() %>"><input
							type="hidden" name="B_RE_REF" value="<%=board.getB_RE_REF() %>"><input
							type="hidden" name="B_RE_LEV" value="<%=board.getB_RE_LEV() %>"><input
							type="hidden" name="B_RE_SEQ" value="<%=board.getB_RE_SEQ() %>">
						...
						<div class="col-xs-2">
							<div class="col-xs-3">
								<a href="javascript:replyboard()"
									class="btn btn-block btn-lg btn-primary">등록</a>
							</div>
							<div class="col-xs-3">
								<a href="javascript:history.go(-1)"
									class="btn btn-block btn-lg btn-inverse">뒤로</a>
							</div>
